package com.example.application.views.subcategorymanagement;
...
@PageTitle("Sub Category Management")
@Route(value = "Subcategory", layout = MainLayout.class)
public class SubCategoryManagementView extends Div {
    ...
    public SubCategoryManagementView() {
        addClassName("sub-category-management-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
